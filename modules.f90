...
!**************************************************************************************
module options
real(8) buffer       ! buffer region to each side
real(8) solvent_mass ! mass of the solvent, ie. 18 for water
real(8) p            ! desired density
real(8) tol          ! packmol minimal molecule distance
integer isolv
character(120) solvfile
logical do_cema      ! make a center-of-mass transformation and exit
logical do_cell      ! just print mol box and vdw box
logical do_addion    ! add ions for physicological conditions (place holder)
end
